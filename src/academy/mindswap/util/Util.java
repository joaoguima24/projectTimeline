...
public class Util {
    ...
    public final static String ITS_YOUR_TURN_TO_PLAY = "/play";
    //"It's your turn to play
    public final static String INSERT_NICKNAME = "/nickname";
    //"Insert your nickname (max 25 characters):"
    public final static String INSERT_PASSWORD = "/password";
    //"Insert your password (max 20 characters):"
    public final static String INSERT_NUMBER_OF_PLAYERS = "/numOfPlayers";
    //"Insert the number of players that you would like to play, between 2 and 8 inclusive"
    public final static String INSERT_NUMBER_OF_CARDS = "/numOfCards";
    //"Insert the number of cards that you would like to have in the deck, between 3 and 6 inclusive"
    public final static String INVALID_PARAMETER_LOGIN_TRY_AGAIN = "/loginAgain";
    //"Invalid parameter, please try again
    public final static String INVALID_PLAY_ = "/playAgain";
    //"Invalid play, please pay attention to the game rules"
    public final static String DO_YOU_WANT_TO_PLAY_AGAIN = "/newGame";
