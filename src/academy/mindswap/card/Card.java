...
public class Card {
    ...
    public static List<Card> deck () {
        ...
        deck.add(new Card("Stephen Hawking passed away", 2019));
        return deck;
    }
    ...
    public static void main(String[] args) {
        System.out.println("Electronics companies agree to make Wi-Fi a worldwide standard for wireless Internet.".length());
    }
}
